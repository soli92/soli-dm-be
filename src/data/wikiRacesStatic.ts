/** Fallback locale se `wiki_srd_cache` è vuota o Supabase non risponde. */
export type WikiRaceDTO = {
  name: string;
  description: string;
...
export const wikiRacesStatic: WikiRaceDTO[] = [
  {
    name: "Dragonborn",
    description:
      "Descended from dragons, dragonborn walk proudly through a world that greets them with fearful incomprehension.",
  ...
  },
  {
    name: "Gnome",
    description:
      "A gnome's energy and enthusiasm for living shines through every inch of his or her body.",
  ...
  },
  {
    name: "Half-Elf",
    description:
      "Half-elves' independence and ambition often drive them toward politics and power.",
  ...
  },
  {
    name: "Halfling",
    description:
      "The diminutive halflings survive in a world full of larger creatures by avoiding notice and, barring that, avoiding offense.",
  ...
  },
  {
    name: "Asimar",
    description:
      "Aasimar are human-based planetouched, native outsiders with a touch of the goodness of the Upper Planes.",
  ...
  },
  {
    name: "Genasi",
    description:
      "Genasi are as varied as their mortal parents but are generally built as they are, roughly humanoid.",
    ability_scores: { Constitution: 2, "Dexterity or Intelligence": 1 },
    size: "Medium",
    speed: "30 ft",
  ...
  },
  {
    name: "Goliath",
    description:
      "Goliaths are giant-kin, standing 7 to 8 feet tall and possessing a natural athleticism that is almost superhuman.",
    ability_scores: { Strength: 2, Constitution: 1 },
    size: "Medium",
    speed: "30 ft",
