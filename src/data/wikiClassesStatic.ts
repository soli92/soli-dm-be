...
export const wikiClassesStatic: WikiClassDTO[] = [
  {
    name: "Barbarian",
    description:
      "A fierce warrior of incredible toughness, relying on primal power.",
    hit_die: "d12",
  ...
  },
  {
    name: "Bard",
    description:
      "An inspiring magician whose power echoes the music of creation itself.",
    hit_die: "d8",
  ...
  },
  {
    name: "Fighter",
    description:
      "A master of weaponry and the martial arts, seeking glory in battle.",
    hit_die: "d10",
  ...
  },
  {
    name: "Ranger",
    description:
      "A guardian and hunter of the wilderness, seeking to protect others in wild places.",
    hit_die: "d10",
    primary_ability: "Dexterity and Wisdom",
    saving_throws: ["Strength", "Dexterity"],
    armor_proficiency: "Light and medium armor, shields",
  ...
  },
  {
    name: "Sorcerer",
    description:
      "A spellcaster who has innate magical ability due to some influence in their lineage.",
    hit_die: "d6",
    primary_ability: "Charisma",
    saving_throws: ["Intelligence", "Wisdom"],
    armor_proficiency: "None",
  ...
  },
  {
    name: "Warlock",
    description:
      "A wielder of magic that is derived from a bargain with an otherworldly being.",
    hit_die: "d8",
    primary_ability: "Charisma",
